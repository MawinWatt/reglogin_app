...
const Profile = () => {
    ...
    const { avatar, username, fname, lname, password, cf_password } = data
    ...
    const handleUpdateProfile = e => {
        e.preventDefault()
        if(password){ 
            const errMsg = valid(username, fname, lname, auth.user.email, password, cf_password)
            console.log(errMsg) 
                ...
                <div className="col-md-4">
                    ...
                    <div className="avatar">
                        ...
                        <span>
                            ...
                            onChange={changeAvatar} accept="image/*" />
                        </span>
                    </div>
                    ...
                    <div className='form-group'>
                        ...
                        <div className="form-row">
                            ...
                            name="fname" value={auth.user.fname} onChange={handleChange} />
                            </div>
                            <div className="col">
                            <input type="text" className="form-control" id="lname"
                            name="lname" value={auth.user.lname} onChange={handleChange} />
                            </div>
                        </div>
                    </div>
                    <div className="form-group">
